...
export function CoverPage({ onStartReading }: CoverPageProps) {
  return (
    <PageSectionWrapper className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-background to-yellow-100 relative text-center overflow-hidden">
      {/* Decorative Icons */}
      <div className="absolute top-4 left-4 animate-pulse">
        <SunflowerIcon className="w-12 h-12 text-accent opacity-70" />
      </div>
      <div className="absolute bottom-4 right-4 animate-pulse">
        <SunflowerIcon className="w-12 h-12 text-accent opacity-70 rotate-90" />
      </div>
      ...
      {/* Main Illustration */}
      <Image
        src="https://zinniaflors.com/modules/ph_simpleblog/featured/104.jpg"
        alt="Ilustración de una pareja de cuento"
        width={400}
        height={300}
      ...
      {/* Titles */}
      <h1 className="text-6xl md:text-7xl font-dancing-script text-primary-foreground mb-4 drop-shadow-md">
      ...
      <Button
        ...
        aria-label="Comenzar a leer nuestra historia"
      >
        Comenzar a Leer
